...
3.  **UI/UX Guard:** During analysis or grooming, if a request impacts the user interface, you must ensure `specs/02-UX-DESIGN.md` is updated (by performing a first draft or recommending `aurelius:design`).
